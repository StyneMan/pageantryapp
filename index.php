      ...
      <div class="container">
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-6 col-md-8 px-5 mb-3">
              <h1 class="text-white" style="font-size: 40px;">The Biggest Night of Beauty</h1>
              <p class="text-lead text-white">Show support to your favourite contestant and get a discount to be there live at the grand finale.</p>
            </div>
          </div>
        </div>
      </div>
